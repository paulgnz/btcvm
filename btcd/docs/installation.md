...
* Install the MSI available at: [btcd windows installer](https://github.com/MetalBlockchain/dogecoin-vm/btcd/releases)
...
```bash
git clone https://github.com/MetalBlockchain/dogecoin-vm/btcd $GOPATH/src/github.com/MetalBlockchain/dogecoin-vm/btcd
...
* [Using bootstrap.dat](https://github.com/MetalBlockchain/dogecoin-vm/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
