...
services:
  btcd:
    container_name: btcd
    hostname: btcd
    build: https://github.com/MetalBlockchain/dogecoin-vm/btcd.git#master
    restart: unless-stopped
    volumes:
      - btcd-data:/root/.btcd
    ports:
