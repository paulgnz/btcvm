...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/MetalBlockchain/dogecoin-vm/btcd/btcutil/txsort)
...
```bash
$ go get -u github.com/MetalBlockchain/dogecoin-vm/btcd/btcutil/txsort
```
