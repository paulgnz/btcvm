...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/MetalBlockchain/btcvm/btcd/netsync)
...
```bash
$ go get -u github.com/MetalBlockchain/btcvm/btcd/netsync
```
