...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/MetalBlockchain/dogecoin-vm/btcd/peer)
...
```bash
$ go get -u github.com/MetalBlockchain/dogecoin-vm/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/MetalBlockchain/dogecoin-vm/btcd/peer#example-package--NewOutboundPeer)  
