...
var sitePages = []sitePage{
	{Path: "/", File: "bridge", Title: "BTCVM bridge",
		Description: "Move BTC between Bitcoin and BTCVM on Metal Blockchain, one for one."},
	{Path: "/explorer", File: "explorer", Title: "BTCVM explorer",
		Description: "Bridge activity, proof of reserves, and BTCVM blocks, transactions and addresses."},
	{Path: "/roadmap", File: "roadmap", Title: "BTCVM roadmap",
		Description: "What's running on BTCVM, how the BTC bridge works, its known limits, and the plan to close them."},
	{Path: "/docs", File: "docs", Title: "BTCVM docs",
		Description: "How BTCVM and its BTC bridge work: deposits, withdrawals, fees and timings, trust and limits, wallets and the API."},
	{Path: "/download", File: "download", Title: "BTCVM Wallet for Mac",
		Description: "A native Mac wallet for Bitcoin and BTCVM: review before you sign, Touch ID for every payment, signed and notarized by Apple."},
}
