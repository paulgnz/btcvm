...
// btcChain reads Bitcoin through Bitcoin Core's JSON-RPC. Addresses must
...
// watch imports address into the Bitcoin Core wallet as watch-only.
func (c *btcChain) watch(address btcutil.Address, rescan bool) error {
	return c.rpc.call(nil, "importaddress", address.EncodeAddress(), "btcvm", rescan)
}
