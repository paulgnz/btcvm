...
//
//	BVMD type hash160      Bitcoin deposit to the peg; credit this VM address
//	BVMI txid vout         VM release crediting that Bitcoin deposit
//	BVMO type hash160      VM peg-out to the reserve; pay this Bitcoin address
//	BVMR txid              Bitcoin payment for that VM peg-out
...
// key or script hash on Bitcoin and on BTCVM.
